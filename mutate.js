...
class Genes {
	...
	constructor( all_characteristics ) {
		...
		/*
		console.log( "Gene successfully created" )
...
function main() {
	...
	var v1 = Genes.generateFromString( "" )
	var v2 = Genes.generateFromString( "0_0_0_0_0_0_0_0_0" )
	var v3 = Genes.generateFromString( "0_1_2_3_4_5_6_7_8" )
	var v4 = Genes.generateFromString( "foobar" )
	var v5 = Genes.generateFromString( "foo_bar" )
	var v6 = queryStrToGene()
	*/
...
function drawBioMorph( ctx, gene )
{
	...
	function drawIteration( gen, len, base_rot, rot, col )
	{
		...
		if( --gen == 0 ) { // this should never go below 0...
			ctx.restore()
			return
		}
